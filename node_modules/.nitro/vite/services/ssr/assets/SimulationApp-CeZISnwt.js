...
import { Eye, EyeOff, Pause, Play, RotateCcw, SkipBack, SkipForward, Video } from "lucide-react";
//#region src/lib/sim/timeline.ts
var RAW = [
	{
		id: "overview",
		kicker: "01",
...
//#endregion
//#region src/components/sim/scene/CameraRig.tsx
function CameraRig() {
...
Math.PI * 2 - .84;
//#endregion
//#region src/lib/sim/textures.ts
...
//#endregion
//#region src/components/sim/scene/Extraction.tsx
...
function Handwheel({ radius = .28 }) {
	return /* @__PURE__ */ jsxs("group", { children: [
		/* @__PURE__ */ jsxs("mesh", { children: [/* @__PURE__ */ jsx("torusGeometry", { args: [
			radius,
			.032,
			8,
			18
		...
		/* @__PURE__ */ jsxs("mesh", { children: [/* @__PURE__ */ jsx("cylinderGeometry", { args: [
			.045,
			.045,
			.08,
			10
...
function Unit({ silo, env }) {
	...
	return /* @__PURE__ */ jsxs("group", {
		...
		children: [
			...
			[-.68, .68].flatMap((x) => [-.68, .68].map((z) => /* @__PURE__ */ jsxs("mesh", {
				position: [
					x,
					OUTLET_Y + .32,
					z
			...
			/* @__PURE__ */ jsxs("group", {
				...
				children: [
					...
					/* @__PURE__ */ jsx("group", {
						...
						children: /* @__PURE__ */ jsx(Handwheel, { radius: .3 })
					})
				]
			}),
			/* @__PURE__ */ jsxs("group", {
				...
				children: [
					...
					[-1.26, 1.26].flatMap((x) => [-.66, .66].map((z) => /* @__PURE__ */ jsxs("mesh", {
						position: [
							x,
							0,
							z
					...
					/* @__PURE__ */ jsxs("mesh", {
						...
						children: [/* @__PURE__ */ jsx("boxGeometry", { args: [
							...
							1.48,
							.04
						] }), /* @__PURE__ */ jsx("meshStandardMaterial", { ...glass })]
					}),
					/* @__PURE__ */ jsxs("mesh", {
						position: [
							0,
			...
			/* @__PURE__ */ jsxs("group", {
				...
				children: [
					...
					showRod && /* @__PURE__ */ jsxs(Fragment, { children: [
						/* @__PURE__ */ jsxs("mesh", {
							position: [
								0,
								.2 - insert * .85,
						...
						env.lance > .12 && /* @__PURE__ */ jsxs("mesh", {
							position: [
								0,
								-1.05 - env.lance * .15,
								0
			...
			showLabels && silo.id === 5 && /* @__PURE__ */ jsxs(Fragment, { children: [
				/* @__PURE__ */ jsx(Html, {
					position: [
						0,
						-3.2,
...
function Trough({ env }) {
	...
	return /* @__PURE__ */ jsxs("group", {
		...
		children: [
			...
			env.flow > .55 && env.jam < .5 && /* @__PURE__ */ jsxs("mesh", {
				position: [
					0,
					.16,
					0
			...
			labels && env.cutaway > .6 && /* @__PURE__ */ jsx(Html, {
				position: [
					0,
					.7,
					.6
...
function Extraction() {
	...
	return /* @__PURE__ */ jsxs("group", { children: [WORKING.map((s) => /* @__PURE__ */ jsx(Unit, {
		silo: s,
		env
	}, s.id)), /* @__PURE__ */ jsx(Trough, { env })] });
}
...
//#endregion
//#region src/components/sim/scene/Flow.tsx
function Flow() {
	const fines = useRef(null);
	const boulders = useRef(null);
	useLayoutEffect(() => {
	...
	return /* @__PURE__ */ jsxs("group", { children: [/* @__PURE__ */ jsxs("instancedMesh", {
		ref: fines,
		args: [
			void 0,
			void 0,
		...
		children: [/* @__PURE__ */ jsx("sphereGeometry", { args: [
			...
			5,
			4
		] }), /* @__PURE__ */ jsx("meshBasicMaterial", { color: "#e2d3b8" })]
	}), /* @__PURE__ */ jsxs("instancedMesh", {
		ref: boulders,
		args: [
			void 0,
			void 0,
		...
		frustumCulled: false,
		castShadow: false,
		children: [/* @__PURE__ */ jsx("icosahedronGeometry", { args: [1, 0] }), /* @__PURE__ */ jsx("meshBasicMaterial", { color: "#6a5340" })]
	})] });
}
//#endregion
//#region src/components/sim/scene/Pit.tsx
var YARD = 160;
var TRENCH_END = 48;
function Pit() {
	const soil = useMemo(() => {
	...
	return /* @__PURE__ */ jsxs("group", { children: [
		/* @__PURE__ */ jsxs("mesh", {
			...
			receiveShadow: true,
			children: [/* @__PURE__ */ jsx("planeGeometry", { args: [100, YARD] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				map: gravel,
				color: "#8a8478",
				roughness: 1
			})]
		...
		/* @__PURE__ */ jsxs("mesh", {
			...
			receiveShadow: true,
			children: [/* @__PURE__ */ jsx("planeGeometry", { args: [w + 2, 80] }), /* @__PURE__ */ jsx("meshStandardMaterial", {
				map: gravel,
				color: "#8a8478",
				roughness: 1
			})]
		...
		WORKING.map((s) => /* @__PURE__ */ jsxs("mesh", {
			position: [
				s.x,
				PIT_FLOOR + .2,
				s.z
...
//#endregion
//#region src/components/sim/scene/Silos.tsx
function Silos() {
	const env = envAt(useSimStore((s) => s.time));
	const cut = env.cutaway > .4;
	const ghost = env.siloGhost;
	return /* @__PURE__ */ jsx("group", { children: SILOS.map((silo) => {
...
//#endregion
//#region src/components/sim/scene/World.tsx
function Gantry() {
	...
	const len = maxX - minX;
	return /* @__PURE__ */ jsx("group", { children: /* @__PURE__ */ jsxs("mesh", {
		position: [
			(minX + maxX) / 2,
			29.2,
			z
...
function World() {
	return /* @__PURE__ */ jsxs(Fragment, { children: [
		...
		/* @__PURE__ */ jsx("ambientLight", { intensity: .72 }),
		...
		/* @__PURE__ */ jsx(Silos, {}),
		/* @__PURE__ */ jsx(Gantry, {}),
		/* @__PURE__ */ jsx(Extraction, {}),
		/* @__PURE__ */ jsx(Flow, {})
	] });
}
//#endregion
//#region src/components/sim/Canvas3D.tsx
function Canvas3D() {
...
//#endregion
//#region src/components/sim/ui/Hud.tsx
...
function Hud() {
	...
	if (!started) return /* @__PURE__ */ jsx("div", {
				...
				/* @__PURE__ */ jsxs("ul", {
					...
					children: [
						/* @__PURE__ */ jsxs("li", {
							...
							children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-moss" }), "12 silozuri — detaliu complet pe silozurile 5 și 7"]
						}),
						/* @__PURE__ */ jsxs("li", {
							className: "flex gap-2",
							children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-moss" }), "Extractor cu două axe, rigolă, poartă glisantă orizontală"]
						}),
						/* @__PURE__ */ jsxs("li", {
							className: "flex gap-2",
							children: [/* @__PURE__ */ jsx("span", { className: "mt-1.5 h-1.5 w-1.5 shrink-0 rounded-full bg-moss" }), "Blocaj → tijă temporară → tunuri de aer → flux restabilit"]
						})
					]
				}),
				/* @__PURE__ */ jsxs("div", {
					...
					children: [/* @__PURE__ */ jsxs("button", {
						...
						children: [/* @__PURE__ */ jsx(Play, { className: "h-4 w-4" }), "Pornește prezentarea"]
					}), /* @__PURE__ */ jsx("button", {
						type: "button",
						onClick: () => {
			...
			/* @__PURE__ */ jsxs("header", {
				...
				children: [/* @__PURE__ */ jsxs("div", {
					...
					children: /* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("span", { className: `mr-2 inline-block h-1.5 w-1.5 rounded-full bg-paper live-dot` }), jammed ? "Flux blocat" : live ? "Flux activ" : "Stand-by"]
					})
				})]
			}),
			/* @__PURE__ */ jsx("div", {
				...
				children: [
					/* @__PURE__ */ jsxs("div", {
						...
						children: [
							...
							/* @__PURE__ */ jsx("div", { className: "mx-1 hidden h-6 w-px bg-line sm:block" }),
							/* @__PURE__ */ jsxs("button", {
								...
								children: [/* @__PURE__ */ jsx(Video, { className: "h-3.5 w-3.5" }), cameraMode === "cinematic" ? "Cameră ghidată" : "Revino la ghidaj"]
							}),
							/* @__PURE__ */ jsxs("button", {
								type: "button",
								...
								children: [labels ? /* @__PURE__ */ jsx(Eye, { className: "h-3.5 w-3.5" }) : /* @__PURE__ */ jsx(EyeOff, { className: "h-3.5 w-3.5" }), "Etichete"]
							}),
							/* @__PURE__ */ jsxs("span", {
					...
					/* @__PURE__ */ jsxs("div", {
						...
						children: [/* @__PURE__ */ jsx("input", {
							...
							children: CHAPTERS.map((c) => /* @__PURE__ */ jsx("button", {
								type: "button",
...
//#endregion
//#region src/components/sim/SimulationApp.tsx
function SimulationApp() {
	...
	return /* @__PURE__ */ jsxs("div", {
		...
		children: [/* @__PURE__ */ jsx(Canvas3D, {}), /* @__PURE__ */ jsx(Hud, {})]
	});
}
//#endregion
