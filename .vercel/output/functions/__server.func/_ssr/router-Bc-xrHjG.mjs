...
//#region node_modules/.nitro/vite/services/ssr/assets/router-Bc-xrHjG.js
var router_Bc_xrHjG_exports = /* @__PURE__ */ __exportAll({ getRouter: () => getRouter });
...
var styles_default = "/assets/styles-DTC9Dz5M.css";
var APP_NAME = "Holcim Simulare Extracție";
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Simulare 3D — silozuri de ciment, blocaje la extracție și tunuri de aer AGICO. Propunere Holcim."
			},
			{
				name: "theme-color",
				content: "#0B1F3A"
...
var $$splitComponentImporter = () => import("./routes-DVCsgjuK.mjs");
...
//#endregion
export { getRouter, router_Bc_xrHjG_exports as t };
