...
var grokOgIdentity = { "site": {
	"title": "Holcim Simulare Extracție",
	"type": "website",
	"card": "custom",
	"color": "0B1F3A",
	"description": "Simulare 3D a extracției din silozurile de ciment Holcim — blocaje, tuneluri de extracție și tunuri de aer AGICO.",
	"image": "/og.jpg"
} };
//#endregion
...
var _lazy_DmI915 = defineLazyEventHandler(() => import("./_chunks/ssr-renderer.mjs"));
var findRoute = /* @__PURE__ */ (() => {
	const data = {
		route: "/**",
		handler: _lazy_DmI915
	};
	return ((_m, p) => {
		return {
			data,
